"""
Runs Bramblewood Creative's data through all seven Business Without You
milestone tools, the second beta test, deliberately a different business
shape from Harbor Fleet Maintenance (Beta Test 1).
"""
...
DATA = f"{ROOT}/outputs/beta-test/bramblewood-creative"
...
# Milestone 4 — high-margin business type, 6 months of data
...
dump(m4.run_full_audit(pnl_raw, breakdown_raw,
                        business_type="Software or other high-margin recurring revenue",
                        period_months=6))
...
dump(m5.run_cash_confidence(cash_raw, exp_raw, starting_balance=20000))
