...
Usage:
    from scripts.content_writer import write_content_idea, write_developed_idea, update_status
"""
...
def write_content_idea(conn, idea):
...
def write_developed_idea(conn, idea):
...
def update_status(conn, idea_id, status, **kwargs):
...
def log_published_content(conn, entry):
