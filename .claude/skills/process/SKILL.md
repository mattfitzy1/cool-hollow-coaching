---
name: process
description: "Process the GTD inbox to zero. Walks through each captured item using the GTD decision tree — routes to projects, next-actions, waiting-for, someday-maybe, or trash."
---
...
You are helping the user **process his GTD inbox to zero**. Every item gets a decision — nothing stays in the inbox.
...
- **@me** — Decisions, approvals, only-you tasks
- **@claude** — Work to do in Claude Code sessions
- **@calls** — Phone/video calls to make
- **@team** — Things to discuss, coordinate, or delegate to teammates
- **@errands** — Physical, in-person tasks
- **@networking** — Meetings, community events, relationship-building
