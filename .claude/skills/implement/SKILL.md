---
name: implement
description: "Execute an implementation plan created by /create-plan"
---
...
plan_path: $ARGUMENTS (path to the plan file, e.g., `plans/2026-01-28-add-restore-flow-to-app.md`)
