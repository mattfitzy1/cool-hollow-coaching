---
name: capture
description: "Quick content idea capture: classify and store as a stub in the pipeline"
---
...
idea: $ARGUMENTS (the raw idea, topic, or observation to capture)
...
from scripts.content_db import get_connection
from scripts.content_writer import write_content_idea
