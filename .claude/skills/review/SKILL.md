---
name: review
description: "Guided weekly review using the GTD methodology. Processes inbox, walks through all project/action lists, scans areas and someday-maybe, rebuilds the dashboard. Run weekly (Fridays recommended). Target: 30-60 minutes."
---
...
You are running the user's **GTD weekly review**. This is the most important habit in the system — it keeps the GTD files trustworthy and complete. Follow the phases below interactively.
