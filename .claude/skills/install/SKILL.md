---
name: install
description: "Install an AIOS module into this workspace with guided setup"
---
...
module_path: $ARGUMENTS (path to the module folder, e.g., `module-installs/context-os-v1`)
...
1. **Read the module's INSTALL.md** from the provided path (e.g., `module-installs/context-os-v1/INSTALL.md`)
