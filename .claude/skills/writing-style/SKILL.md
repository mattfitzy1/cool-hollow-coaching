...
When any rule below conflicts with the client's brand voice, **`context/voice-and-tone.md` wins.** This skill is the floor (no slop). The voice profile is the ceiling (the brand's specific tone, vocabulary, and structure).

US English. Where the brand register asks for something this skill would otherwise flag (a quieter line; a deliberate piece of whitespace), the voice profile wins. When in doubt, match `voice-and-tone.md` before this skill's generic rules.

One brand-specific floor on top of the generic ban list: never use any words the brand has explicitly purged (check `context/voice-and-tone.md` and `context/brand.md`), and never drift into off-brand phrasing the brand has ruled out. These sit alongside the banned-words list below.
...
5. **Start with content, not setup.** First sentence must contain real information. No throat-clearing. On Instagram the first line carries the post, so make it land.
...
"[Noun]. That's it. That's the [thing]." / "X. And Y. And Z." Write complete sentences instead.
...
These show the floor against a plain, specific, on-brand voice. The good versions are concrete; they avoid hype and any purged words. (Match the brand's own register from `context/voice-and-tone.md`.)

**AI slop:**
> "Unlock your business's full potential and transform your operations with our revolutionary, holistic growth journey that empowers you to scale freely."

**On-brand:**
> "Start with the work only you do today. Over twelve weeks, we hand each piece to someone else so the business runs without you in the room."

---

**AI slop:**
> "In today's fast-paced business landscape, our seamless platform helps you embark on a transformative journey toward your best self."

**On-brand:**
> "Most owners are the bottleneck and don't see it. We map what you're holding, then build the systems and people to carry it."

---

**AI slop:**
> "We are passionate about empowering you to optimize, streamline, and accelerate your way to a vibrant, elevated enterprise."

**On-brand:**
> "Clear ownership, written processes, and a team that decides without you. The change is structural, and it holds."
...
9. **Voice check:** does the output match the audience tone in `context/voice-and-tone.md`? If the two rulesets disagree, voice-and-tone.md wins.
