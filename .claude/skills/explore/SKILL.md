---
name: explore
description: "Interactive exploration of a new feature, system, or capability — shapes an idea into a buildable concept"
---
...
1. Based on discovery + research + user input, define:
   ...
   - **How it connects** — relationship to existing workspace systems (does it read from your content pipeline? Update your context files? Post a draft to your social folder?)
