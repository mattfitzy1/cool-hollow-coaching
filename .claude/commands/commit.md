...
### Step 5b: Voice and Tone Check

After the main commit, quickly assess: did this session involve drafting anything in the owner's name (emails, messages, LinkedIn posts, proposals) where the owner corrected the tone, phrasing, or style?

If yes:
1. Read `context/voice-and-tone.md`
2. Add or update the relevant pattern based on what was corrected or confirmed
3. Stage and commit: `update: refine voice-and-tone from session feedback`

If no corrections or drafting happened, skip this step silently.
