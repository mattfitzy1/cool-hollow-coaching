...
Delivered to Slack or email. (The Telegram bot was retired on 15 June 2026; Slack/email delivery via the `brief.py` rebuild is in progress — until then, read briefs from `outputs/daily-brief/`.)
