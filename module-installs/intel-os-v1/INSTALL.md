...
3. **Add team members** — If you hire someone new, add them to the staff registry so classification stays accurate:
   ...
   conn.close()
   ```
4. **Remote Control** — drive your AIOS from your phone (built into Claude Code, no bot) so you can query your IntelOS database on the go: "What did we discuss in yesterday's standup?"
